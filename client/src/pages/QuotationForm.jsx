...
//   useEffect(() => {
//     const totalAmount = formValues.items.reduce((acc, item) => {
//       return acc + parseFloat(item.total_price || 0);
//     }, 0);

//     const gstCalculated =
//       (totalAmount * parseFloat(formValues.tax_percent || 0)) / 100;
//     setFormValues((prev) => ({
//       ...prev,
...
//   }, [formValues.items, formValues.tax_percent, formValues.gstcalculated]);
...
//                     <input
//                       name='total_price'
//                       value={item.month * item.monthly_price}
//                       onChange={(e) => handleItemChange(index, e)}
//                       placeholder='Total Price'
//                       className='border border-gray-300 rounded-md p-2 w-full'
//                     />
